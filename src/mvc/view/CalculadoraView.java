...
public class CalculadoraView extends JFrame {
	...
	public CalculadoraView(JTextField numero1, JLabel rotuloSoma, JTextField numero2, JButton botaoCalcular,
			JTextField resultado) throws HeadlessException {
		super();
		this.numero1 = numero1;
		this.rotuloSoma = rotuloSoma;
